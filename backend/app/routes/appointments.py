...
async def book_appointment(request: Request, data: BookingData, db: Session = Depends(get_db)):
    try:
        ...
        appointment = Appointment(booking_id=booking_id, clinic_id=data.clinic_id, doctor_id=data.doctor_id, patient_name=data.patient_name, patient_phone=data.patient_phone, patient_age=data.patient_age, patient_gender=data.patient_gender, appointment_date=data.appointment_date, time_slot=data.time_slot, slot_number=slot_num, booking_type="online", status="waiting")
        ...
        return {"id": appointment.id, "booking_id": appointment.booking_id, "clinic_id": appointment.clinic_id, "doctor_id": appointment.doctor_id, "patient_name": appointment.patient_name, "patient_phone": appointment.patient_phone, "patient_age": appointment.patient_age, "patient_gender": appointment.patient_gender, "appointment_date": str(appointment.appointment_date), "time_slot": appointment.time_slot, "slot_number": appointment.slot_number, "booking_type": appointment.booking_type, "status": appointment.status, "clinic_name": clinic.name, "doctor_name": doctor.name, "created_at": str(datetime.now())}
